// ARCHIVO AUTO-GENERADO POR PARSER
// Creditos a: https://github.com/Ditectrev/Amazon-Web-Services-AWS-Certified-Cloud-Practitioner-CLF-C02-Practice-Tests-Exams-Questions-Answers

const dataExamsMaster = [
    {
    ...
    {
        "q": "Which AWS service of feature can be used to monitor CPU usage?",
        "options": [
            "AWS CloudTrail.",
            "VPC Flow Logs.",
            "Amazon CloudWatch.",
    ...
    {
        "q": "Which mechanism allows developers to access AWS sendees from application code?",
        "options": [
            "AWS Software Development Kit.",
            "AWS Management Console.",
            "AWS CodePipeline.",
    ...
    {
        "q": "Which type of mirroring does SPAN technology perform?",
        "options": [
    ...
    {
        "q": "Your customer wants to grant restricted proxy rights to their HR Department to act on behalf of employees belonging to their legal entity. How can you perform this requirement? There are 2 correct answers to this question.",
        "options": [
    ...
    {
        "q": "Which two statements about configuring a traffic monitoring session are true? (Choose two)",
        "options": [
    ...
    {
        "q": "A company wants to migrate its applications from its on-premises data center to a VPC in the AWS Cloud. These applications will need to access on-premises resources. Which actions will meet these requirements? (Choose TWO)",
        "options": [
...
// Exponemos de alguna forma
if (typeof module !== 'undefined') module.exports = dataExamsMaster;
